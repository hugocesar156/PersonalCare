...
namespace PersonalCare.Application.Services
{
    ...
    {
        public static string GerarTokenAutenticacaoConta(Conta conta, string idEmpresa, string signingKey)
        {
            ...
            var tokenDescriptor = new SecurityTokenDescriptor
            {
                ...
                {
                    new Claim(PersonalCareClaims.ID_CONTA, conta.Id.ToString()),
        ...
        public static string GerarTokenAutenticacaoUsuario(Usuario usuario, string idEmpresa, string signingKey)
        {
            var tokenHandler = new JwtSecurityTokenHandler();
            var key = Encoding.ASCII.GetBytes(signingKey);
